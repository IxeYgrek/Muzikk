 ...
 *
 * Sections come from the language files, so the table of contents and the
 * anchors follow the translation rather than being maintained by hand.
 */
...
<section class="doc-hero">
    <div class="shell doc-hero__inner">
        <p class="eyebrow"><?= t('common.nav.docs') ?></p>
        <h1><?= t('docs.title') ?></h1>
